...
COMMENT ON COLUMN "PENTAHO"."C_GI_CREDIT_SUMMARY"."FY_3PP_PLDG_PAID_TTL_AMT" IS 'Sum amount of GI_CREDIT_DETAIL.THIRD_PARTY_PLEDGE_PAID_TOTAL each year as of end of reporting FY.';
...
COMMENT ON COLUMN "PENTAHO"."C_GI_CREDIT_SUMMARY"."FY_3PP_PLDG_PAID_TTL_COUNT" IS 'Count of GI_CREDIT_DETAIL.THIRD_PARTY_PLEDGE_PAID_TOTAL each year as of end of reporting FY.';
...
COMMENT ON COLUMN "PENTAHO"."C_GI_CREDIT_SUMMARY"."FY_3PP_PLDG_PAID_TTL_DCNT" IS 'Count by distinct date of GI_CREDIT_DETAIL.THIRD_PARTY_PLEDGE_PAID_TOTAL each year as of end of reporting FY.';
...
COMMENT ON COLUMN "PENTAHO"."C_GI_CREDIT_SUMMARY"."LT_3PP_PLDG_PAID_TTL_AMT" IS 'Sum amount of GI_CREDIT_DETAIL.THIRD_PARTY_PLEDGE_PAID_TOTAL cummulative lifetime to end of reporting year.';
...
COMMENT ON COLUMN "PENTAHO"."C_GI_CREDIT_SUMMARY"."LT_3PP_PLDG_PAID_TTL_COUNT" IS 'Count of GI_CREDIT_DETAIL.THIRD_PARTY_PLEDGE_PAID_TOTAL cummulative lifetime to end of reporting year.';
...
COMMENT ON COLUMN "PENTAHO"."C_GI_CREDIT_SUMMARY"."LT_3PP_PLDG_PAID_TTL_DCNT" IS 'Count by distinct date of GI_CREDIT_DETAIL.THIRD_PARTY_PLEDGE_PAID_TOTAL cummulative lifetime to end of reporting year.';
